...
from eezydataapi.app.utils.security import (
...
@pytest.mark.asyncio
@mock.patch("eezydataapi.app.utils.security.jwt.decode",
...
@pytest.mark.asyncio
@mock.patch("eezydataapi.app.utils.security.AuthUser.get_user")
...
@mock.patch("eezydataapi.app.utils.security.datetime")
@mock.patch("eezydataapi.app.utils.security.settings")
