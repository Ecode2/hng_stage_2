...
import click
import logging
from eezydataapi.app.utils.logging import ColorFormatter, request_msg_format
...
class TestColorFormatter:
    ...
    @mock.patch("eezydataapi.app.utils.logging.click.style",
    ...
    @mock.patch("eezydataapi.app.utils.logging.logging.Formatter")
