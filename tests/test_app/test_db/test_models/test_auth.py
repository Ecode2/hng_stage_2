...
from eezydataapi.app.schemas.auth import AuthUserPublic
from eezydataapi.app.db.models import AuthUser
...
@mock.patch("eezydataapi.app.db.models.auth.pwd_context.hash",
...
@mock.patch("eezydataapi.app.db.models.auth.AuthUser.get_password_hash",
            return_value="dummy")
