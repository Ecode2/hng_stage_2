...
from eezydataapi.app.utils.security import create_access_token
...
@mock.patch("eezydataapi.app.api.auth.create_access_token",
...
@mock.patch("eezydataapi.app.api.auth.store_user",
